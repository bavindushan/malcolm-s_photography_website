<?php
  ...
  if(!isset($_SESSION["username"]) && !isset($_SESSION["password"])){
    header('Location: cus-login.php'); // if session invalid
    exit;
  }
?>
<!DOCTYPE html>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
          ...
          <table class="table w-100">
              ...
              <?php 
                ...
                if (!$conn){
                  ...
                  $sql = "SELECT * FROM `enquaries_table` JOIN `logintable` on `enquaries_table`.`user_id` = `logintable`.`user_id` WHERE `logintable`.`user_id` = '$userid';";
    ...
    <div class="accordion-item">
      ...
      <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
        <h3></h3>
        <span class="btn-container w-100">
            <button class="btn btn-primary">
                <?php
                    echo"<a style='color:white;' href='enquaries.php?userid=".urlencode($userid)."'>Create an Enquary</a>";
                ?>
            </button>
            <button class="btn btn-primary">
                <?php 
                    echo"<a style='color:white;' href='feedback.php?userid=".urlencode($userid)."'>Leave a Feedback</a>";
                ?>
            </button>
        </span>
