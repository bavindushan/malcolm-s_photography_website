...
<body class="login-body">
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    ...
    <form action="cus-login.php" method="post">
        <div class="flex-centered" style="height: 80vh;">
            <div class="w-50 login-container">
                <h1 style="text-align: center;margin: 0%;">Customer Login</h1>
                <div class="mb-3 ">
                ...
                <button class="btn btn-success w-100" onclick="return verifyUserLogin()">Login</button>             
    ...
    if(isset($_POST["txtUser"])){
        ...
        if (!$conn){
            ...
            $sql = "SELECT * From logintable where user_name='". $unm . "' and user_psw='" . $upass . "'";
            ...
            if($result->num_rows > 0){
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    $redirectUrl = 'cus_dashboard.php?userid=' . urlencode($uid);
                ...
                echo "<script>window.location.href='cus-login.php';alert('Wrong username or password. Please, try again.');</script>";
